...
class Player{
	...
	var property image  
	var goles = 0
	var property tirar = false
	var property oldPosition = game.center()
	var property estaCorriendo = false
	var property freeze = false
	var property banner 
...
const jugador1 = new Player(image = "fichaarg.png", position = game.at(4,9), banner = "ganoArgentina.png")
const jugador2= new Player(image = "fichaalem.png", position = game.at(30,9), banner = "ganoAlemania.png")
